...
"""""
1. Create Function to return the Master Data
2. Create function to Check if the customer qualifies
3. Create Function to handle the Business Rules
4. Call the functions to run the LMS
